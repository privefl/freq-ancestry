...
However, these datasets are not very large and do not provide many individuals per population.
The UK Biobank project is a prospective cohort study with deep genetic and phenotypic data collected on almost 500,000 individuals from across the United Kingdom.
...
Here we carefully use information on self-reported ancestry, country of birth, and genetic similarity to define 26 distinct ancestry groups from the UK Biobank to be used as global reference populations. 
...
% 185 words
Then, as a use-case for this new reference set of allele frequencies we provide, we propose to estimate global ancestry proportions from a cohort based on its allele frequencies only.
...
Citations for the allele frequencies used: the UK Biobank (UKBB, \cite{bycroft2018uk}), the Biobank Japan (BBJ, \cite{sakaue2021cross}), FinnGen (\url{https://r5.finngen.fi/}), GERA \cite[]{hoffmann2018large}, PAGE \cite[]{wojcik2019genetic}, kidney function \cite[]{yu2021polygenic}, COVID-19 \cite[]{ganna2021mapping}, epilepsy \cite[]{consortium2018genome}, body fat percentage \cite[]{lu2016new}, eczema \cite[]{paternoster2015multi}, prostate cancer (PrCa, \cite{schumacher2018association}), breast cancer (BrCa, \cite{michailidou2017association}), and coronary artery disease (CAD, \cite{nikpay2015comprehensive}). Several of them have been downloaded through the NHGRI-EBI GWAS Catalog \cite[]{macarthur2017new}. 
...
Measuring genetic diversity is an important problem because increasing genetic diversity is key to making new genetic discoveries, while also being a major source of confounding to be aware of in genetics studies.
This is one of the many applications of the new set we provide.
