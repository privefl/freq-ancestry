...
This is described in more details in the Supplementary Materials.
...
\begin{table}[htb]
	...
	\begin{tabular}{|l|c||c|c|c|c|c||c|c|c|c|c|c|c|c|c|c|}
		...
		\hline
	\end{tabular}
	\caption{Reference population with their size (N), and corresponding ancestry proportions (in \%) from several GWAS datasets.
