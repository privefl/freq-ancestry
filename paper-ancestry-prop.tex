...
Here we develop a method that use allele frequencies derived from these ancestry groups to effectively measure diversity from summary statistics of any genetic dataset.\\
...
These include nine groups with genetic ancestries from Europe, four from Africa, three from South Asia, three from East Asia, one from the Middle East, and one from South America (Table \ref{tab:table1}).
